...
function body() {
  ...
  wrap.innerHTML = `
    ...
    <ul>
      ...
      at <code>routing.openstreetmap.de</code> (no API key). If it doesn't respond, the
      app automatically retries against FOSSGIS's
      <a href="https://valhalla.openstreetmap.de" target="_blank" rel="noopener">Valhalla</a>
      instance. Optional: paste a free
